      ...
      {loading ? (
        ...
        <div className=" w-full px-3 py-10 lg:px-24">
          <div className="flex gap-1 items-center text-xs md:text-base">
            <Link to={"/projects"} className="text-good-blue font-semibold">
              Projects
            </Link>
            <FaAngleRight className="text-dark-blue dark:text-white" />
            <p className="text-good-blue font-semibold">
              {project?.kategori.judul_kategori}
            </p>
            <FaAngleRight className="text-dark-blue dark:text-white" />
            <p className="text-dark-blue dark:text-white font-semibold">
              {project?.judul}
            </p>
          </div>
          ...
          <div className="w-full h-[250px] md:h-[600px] overflow-hidden rounded-xl">
            <img
              ...
              src={`${BASE_API_URL}/storage/${project?.gambar_utama}`}
              alt=""
            />
          </div>
          <div className="grid grid-cols-4 h-20 md:h-64 mt-2 md:mt-5 gap-2 md:gap-4">
            <div className="w-full h-full overflow-hidden rounded-xl">
              <img
                className="w-full h-full object-cover"
                src={`${BASE_API_URL}/storage/${project?.gambar1}`}
                alt=""
              />
            </div>
            <div className="w-full h-full overflow-hidden rounded-xl">
              <img
                className="w-full h-full object-cover"
                src={`${BASE_API_URL}/storage/${project?.gambar2}`}
                alt=""
              />
            </div>
            <div className="w-full h-full overflow-hidden rounded-xl">
              <img
                className="w-full h-full object-cover"
                src={`${BASE_API_URL}/storage/${project?.gambar3}`}
                alt=""
              />
            </div>
            <div className="w-full h-full overflow-hidden rounded-xl">
              <img
                className="w-full h-full object-cover"
                src={`${BASE_API_URL}/storage/${project?.gambar4}`}
                alt=""
              />
            </div>
          </div>
          ...
          <div className="md:grid md:grid-cols-3 py-10 gap-7">
            ...
            <div className="mt-12 md:mt-0">
              <h3 className="text-lg font-semibold text-dark-blue dark:text-white pb-3">
                Hasil Karya Lainnya
              </h3>
